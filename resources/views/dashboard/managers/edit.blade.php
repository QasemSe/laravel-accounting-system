...
@section('title'){{ __('Managers __ Edit Manager') }}@endsection
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!--begin::Col-->
                    <div class="col-12">
                        <form action="{{ route('dashboard.managers.update', $manager->id) }}" method="post" id="kt_form" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                                <div class="card-header">
                                    <div class="card-title">
                                        ...
                                        <h3 class="card-label">{{ __('Edit Manager') }}</h3>
                                    </div>
                                        ...
                                        <div class="col-xl-9">
                                            <div class="my-5">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="image-input image-input-outline" id="kt_user_edit_avatar">
                                                            <div class="image-input-wrapper" style="background-image: url({{ asset($manager->getAvatarPath()) }})"></div>
                                                ...
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg" name="first_name" type="text" value="{{ $manager->first_name }}" required>
                                                    </div>
                                                </div>
                                                <!--end::Group-->
                                                <!--begin::Group-->
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg" name="last_name" type="text" value="{{ $manager->last_name }}" required>
                                                    </div>
                                                </div>
                                                <!--end::Group-->
                                                <!--begin::Group-->
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="input-group input-group-solid input-group-lg">
                                                            ...
                                                            <input type="email" class="form-control form-control-solid form-control-lg" name="email" value="{{ $manager->email }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end::Group-->
                                                        ...
                                                        <div class="checkbox-inline">
                                                            @foreach($maps as $map=>$color)
                                                                <label class="checkbox checkbox-{{ $color }}">
                                                                    <input type="checkbox" {{ $manager->hasPermission($model . '-' . $map) ? 'checked' : null }}
