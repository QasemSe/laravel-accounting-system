                        ...
                        <div class="table-responsive">
                            <table class="table table-vertical-center" id="kt_advance_table_widget_2">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th style="min-width: 120px">{{ __('Invoice Number') }}</th>
                                    <th style="min-width: 120px">{{ __('Customer') }}</th>
                                    <th style="min-width: 150px">{{ __('Amount') }}</th>
                                    <th style="min-width: 150px">{{ __('Date') }}</th>
                                    <th style="min-width: 150px">{{ __('Due Date') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
                                                <a href="{{ route('dashboard.sales.invoices.show', $invoice->id) }}">
                                                    {{ $invoice->invoice_number }}
                                                </a>
                                            </span>
                                        </td>
                                        <td>
                                            <span class="text-dark-75 d-block ">{{ $invoice->getCustomerName() }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-75 d-block ">{{ $invoice->total }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-75  d-block ">{{ \Carbon\Carbon::parse($invoice->invoiced_at)->isoFormat('DD-MM-YYYY') }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-75 d-block">{{ \Carbon\Carbon::parse($invoice->due_at)->isoFormat('DD-MM-YYYY') }}</span>
                                        </td>
                                        <td class="pr-0 text-right">
                                            <a href="{{ route('dashboard.sales.invoices.edit', $invoice->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" title="{{ __('Edit') }}">
                                            ...
                                            <form class="d-inline" action="{{ route('dashboard.sales.invoices.destroy', $invoice->id) }}" method="post">
                                                @csrf
                                                @method('delete')

                                                <button type="button" data-invoice-name="{{ $invoice->invoice_number }}"
                                                        class="confirm-invoice-delete btn btn-icon btn-light btn-hover-danger btn-sm" title="{{ __('Delete') }}">
