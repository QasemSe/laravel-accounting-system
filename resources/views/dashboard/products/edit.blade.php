        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!--begin::Col-->
                    <div class="col-12">
                        <form method="post" id="create_manager_form" data-action="{{ route('dashboard.products.update', $product->id) }}">
                            @csrf
                            @method('put')
                                            ...
                                            <div class="my-5">
                                                ...
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg" value="{{ $product->name }}"
                                                               id="name" name="name" type="text" placeholder="{{ __('Product Name') }}" required>
                                                ...
                                                <!--begin::Group-->
                                                <div class="form-group row fv-plugins-icon-container">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">{{ __('Product Description') }}</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <textarea aria-label="Category Description" placeholder="{{ __('Product Description') }}"
                                                                  class="form-control form-control-solid form-control-lg"
                                                                  id="description" name="description" type="text">{{ $product->description }}</textarea>
                                                ...
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg" placeholder="{{ __('Purchase Price') }}"
                                                               id="purchase_price" name="purchase_price" type="number" value="{{ $product->purchase_price }}" required>
                                                        <div id="purchase_price_error" class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                                <!--end::Group-->
                                                ...
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg" placeholder="{{ __('Sale Price') }}"
                                                               id="sale_price" name="sale_price" type="number" value="{{ $product->sale_price }}" required>
                                                        <div id="sale_price_error" class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                                <!--end::Group-->
                                                ...
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg" value="{{ $product->quantity }}"
                                                ...
                                                <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <select class="form-control form-control-solid form-control-lg" name="category_id">
                                                            <option>{{ __('--Undefined--') }}</option>
                                                            @foreach($categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                    {{ $product->category->id == $category->id ? 'selected' : null }}>{{ $category->name }}</option>
                                                            @endforeach
                                                        </select>
